...
<%@ Register TagPrefix="SharePoint" Namespace="Microsoft.SharePoint.WebControls" Assembly="Microsoft.SharePoint, Version=12.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %><asp:content id="content2" runat="server" contentplaceholderid="PlaceHolderMain"><WebPartPages:DataFormWebPart runat="server" IsIncluded="True" FrameType="None" NoDefaultStyle="TRUE" ViewFlag="0" Title="" __markuptype="vsattributemarkup" __WebPartId="{8A384CD8-D187-4092-8E84-98CA60C8EC12}" id="InitiationForm" pagesize="1">
	<DataSources>
		<SharePoint:SPWorkflowDataSource BaseTemplateID="{2060C41B-FDF4-4156-841C-25EC6AF9A405}" ListID="{DA471114-2E01-4911-A0FD-9C945FD14177}" runat="server" id="SPWorkflowDataSource2"><SelectParameters><WebPartPages:DataFormParameter Name="AssociatedTemplateID" ParameterKey="AssociatedTemplateID" PropertyName="ParameterValues"/></SelectParameters><InsertParameters><WebPartPages:DataFormParameter Name="ItemID" ParameterKey="ItemID" PropertyName="ParameterValues"/><WebPartPages:DataFormParameter Name="AssociatedTemplateID" ParameterKey="AssociatedTemplateID" PropertyName="ParameterValues"/></InsertParameters></SharePoint:SPWorkflowDataSource>
	</DataSources>
...
<xsl:stylesheet xmlns:x="http://www.w3.org/2001/XMLSchema" xmlns:dsp="http://schemas.microsoft.com/sharepoint/dsp" version="1.0" exclude-result-prefixes="xsl msxsl ddwrt" xmlns:ddwrt="http://schemas.microsoft.com/WebParts/v2/DataView/runtime" xmlns:asp="http://schemas.microsoft.com/ASPNET/20" xmlns:__designer="http://schemas.microsoft.com/WebParts/v2/DataView/designer" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:SharePoint="Microsoft.SharePoint.WebControls">
	...
	<xsl:template name="dvt_1.rowedit">
		<tr>
			<td>
				<table border="0" cellspacing="0" width="100%"><tr><td colspan="2" class="ms-pagetitle">SMT-Setup Update</td></tr><tr><td colspan="2" class="ms-formbody">To initiate SMT-Setup Update, click Start.</td></tr></table>
			</td>
		</tr>
	</xsl:template>
